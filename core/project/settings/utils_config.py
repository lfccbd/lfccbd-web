...
MAINTENANCE_MODE_IGNORE_ADMIN_SITE = ENV.config(
    'MAINTENANCE_MODE_IGNORE_ADMIN_SITE', cast=bool
)
MAINTENANCE_MODE_IGNORE_ANONYMOUS_USER = ENV.config(
    'MAINTENANCE_MODE_IGNORE_ANONYMOUS_USER', cast=bool
)
MAINTENANCE_MODE_IGNORE_AUTHENTICATED_USER = ENV.config(
    'MAINTENANCE_MODE_IGNORE_AUTHENTICATED_USER', cast=bool
)
MAINTENANCE_MODE_IGNORE_STAFF = ENV.config('MAINTENANCE_MODE_IGNORE_STAFF', cast=bool)
MAINTENANCE_MODE_IGNORE_SUPERUSER = ENV.config(
    'MAINTENANCE_MODE_IGNORE_SUPERUSER', cast=bool
)
...
MAINTENANCE_MODE_GET_CONTEXT = (
    None
    if ENV.config('MAINTENANCE_MODE_GET_CONTEXT') == 'None'
    else ENV.config('MAINTENANCE_MODE_GET_CONTEXT')
)  # noqa: E501
MAINTENANCE_MODE_IGNORE_TESTS = ENV.config('MAINTENANCE_MODE_IGNORE_TESTS', cast=bool)
MAINTENANCE_MODE_LOGOUT_AUTHENTICATED_USER = ENV.config(
    'MAINTENANCE_MODE_LOGOUT_AUTHENTICATED_USER', cast=bool
)
...
MAINTENANCE_MODE_IGNORE_URLS = ENV.config(
    'MAINTENANCE_MODE_IGNORE_URLS', cast=ENV.Csv()
)
