...
class ImageSlider(models.Model):
    ...
    image_1 = models.ImageField(
        upload_to='resources/sliders/', help_text='slider image'
    )
...
class Media(models.Model):
    ...
    sermon_type = models.CharField(
        max_length=100, choices=sermon_type, default='Audio', help_text='file type'
    )
    media_format = models.CharField(
        max_length=100, choices=media_type, default='Audio', help_text='file type'
    )
    service = models.CharField(
        max_length=200, help_text='service name in which message was preached'
    )
...
class Book(models.Model):
    ...
    featured_image = ResizedImageField(
        size=[207, 207], upload_to='resources/books/', help_text='main image'
    )
    image_1 = ResizedImageField(
        size=[207, 207], upload_to='resources/books/', help_text='gallery image'
    )
