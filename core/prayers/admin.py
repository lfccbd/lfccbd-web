...
class PrayerRequestAdmin(admin.ModelAdmin):
	list_display = ['first_name', 'last_name', 'date_received']
	list_display_links = ['first_name', 'last_name', 'date_received']
	date_hierarchy = 'date_received'
	list_per_page = 50
	actions_on_top = True
	actions_on_bottom = True
	readonly_fields = ['first_name', 'last_name', 'prayer', 'date_received']
	save_as = True
	save_as_continue = True
	save_on_top = True
	search_fields = ['first_name', 'last_name', 'prayer', 'date_received']
	fields = ['first_name', 'last_name', 'prayer', 'date_received']
